...
function renderQuestion() {
  ...
  $('question-image').src = DATA_ROOT + q.image;
...
$('retry-image').onclick = () => { $('question-image').hidden=false; $('image-error').hidden=true; $('question-image').src=DATA_ROOT+currentQuestion().image; };
$('zoom').onclick = () => { $('large-image').src=DATA_ROOT+currentQuestion().image; $('large-image').alt=$('question-image').alt; $('large-image').classList.remove('enlarged'); $('actual-size').setAttribute('aria-pressed','false'); $('image-dialog').showModal(); };
